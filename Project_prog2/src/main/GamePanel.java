...
public class GamePanel extends JPanel implements Runnable {
	...
	public void run() {
		...
		while (m_gameThread != null) { // Tant que le thread du jeu est actif
			...
			// Dessine sur l'ï¿½cran le personnage et la map avec les nouvelles
			// informations. la mï¿½thode "paintComponent" doit obligatoirement ï¿½tre
			// appelï¿½e avec "repaint()"
			this.repaint();
